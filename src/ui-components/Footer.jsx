  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 405184575")}
      >
        <Flex
          gap="8px"
          direction="column"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 405184588")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="© 2024 Pinocchio’s Studio All rights reserved."
          {...getOverrideProps(
            overrides,
            "\u00A9 2024 Pinocchio\u2019s Studio All rights reserved."
          )}
        ></Text>
      </Flex>
    </Flex>
